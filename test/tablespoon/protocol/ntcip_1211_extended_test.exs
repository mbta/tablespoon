defmodule Tablespoon.Protocol.NTCIP1211ExtendedTest do
  ...
  @encoded_sample <<0x30, 0x49, 0x02, 0x01, 0x00, 0x04, 0x0D, 0x61, 0x64, 0x6D, 0x69, 0x6E, 0x69,
                    0x73, 0x74, 0x72, 0x61, 0x74, 0x6F, 0x72, 0xA3, 0x35, 0x02, 0x01, 0x00, 0x02,
                    0x01, 0x00, 0x02, 0x01, 0x00, 0x30, 0x2A, 0x30, 0x28, 0x06, 0x0D, 0x2B, 0x06,
                    0x01, 0x04, 0x01, 0x89, 0x36, 0x04, 0x02, 0x0B, 0x02, 0x05, 0x00, 0x04, 0x17,
                    0xF1, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20,
                    0x20, 0x33, 0x38, 0x32, 0x35, 0x02, 0x00, 0x02, 0x00, 0x05>>

  describe "encode/1" do
    test "encodes a message the same way the old software did" do
      assert :binary.bin_to_list(IO.iodata_to_binary(NTCIP.encode(@sample_message))) ==
               :binary.bin_to_list(@encoded_sample)
    end
  end
